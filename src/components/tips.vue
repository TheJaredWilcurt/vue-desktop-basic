  ...
  <section>
    ...
    <ul>
      ...
      <li>
        ...
        <li>You do not need to use CSS Resets or Normalizers. What ever CSS works for you will work for 100% of your end users because you are handing them the browser you developed on.</li>
  ...
  module.exports = {
    ...
    computed: {
      settingsFile: function () {
        ...
        var settingsFileLocation = path.join(nw.App.dataPath, 'settings.json');
